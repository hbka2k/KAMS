	...
	<div id="footer" class="wd_ka">
		<div class="f_top">
			<div class="wrap">
				<div class="family_site_box">
					...
					<div class="family_site">
						...
						<ul id="familySite_4">
							...
							<li><a href="http://www.sd.go.kr/sd/main.do" class="export_link"  target="_blank">성동구</a></li>
				...
				<div class="top_btn">
					<button type="button">
						<img src="/ssem/artmore_adm/resources/img/common/top_bg.png" alt="top"><br>
					</button>
				</div>
			</div>
		</div>
		<div class="wrap">
			<div class="f_table">
				<h1 class="f_logo">
					<a href="/ssem/youth/main/main.do"><img src="/ssem/artmore_adm/resources/img/common/logo_footer.png" alt="송파쌤"></a>
				</h1>
				...
				<div class="f_info_box">
					...
					<div class="f_info">
						<span class="line_md_none mb_md_10">[05552] 서울특별시 송파구 올림픽로 326 (신천동)</span><br class="screen_hide screen_md_show ">
						<span>TEL. 02-2147-2375 </span><span>FAX. 2147-3861</span>
					</div>
					<p class="copy">
