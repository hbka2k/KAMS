...
<div id="people" class="sub">
                    ...
                    <div class="jobs_sch_cont">
                        ...
                        <div class="jobs_sch_detail cf">
                            <div class="jobs_sch_li">
                                ...
                                <button type="button" id="" class="jobs_sch_pop_btn" onclick="popUp('jobs_type_pop')">장르 선택</button>
                            </div>
                            <div class="jobs_sch_li">
            ...
            <div class="board_tb_wrap person_sch_tb_wrap">
                ...
                <table class="board_tb person_sch_tb">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="ta_l">
                                <a href="/sub/human/type_view.do" class="jobs_cname">홍길동</a>
    ...
    <!--장르 선택 팝업 {-->
    <div id="jobs_type_pop" class="popup_dim">
