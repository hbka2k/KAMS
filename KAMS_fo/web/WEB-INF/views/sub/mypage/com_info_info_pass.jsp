                        ...
                        <div class="mp_sec mp_mbedit_name_sec">
                            ...
                            <div class="mp_mbedit_tb_wrap">
                                <table class="signup_fm_tb mp_mbedit_tb">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th><label for="mp_mbedit_chk_id">아이디</label></th>
                                            <td>
                                                <div class="signup_fm_name_fs0">
                                                    <input type="text" name="" id="mp_mbedit_chk_id" class="i-inpt mp_mbedit_id">
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="mp_mbedit_submit_box cf">
                                <ul class="mp_mbedit_submit_ul mp_mbedit_submit_ul02">
                                    ...
                                    <li><button type="button" id="mp_mbedit_submit" class="btn01" onclick="location.href='/sub/mypage/com_info_info_pass_edit.do'">확인</button></li>
                                </ul>
                            </div>
                        </div>
                    </form>
