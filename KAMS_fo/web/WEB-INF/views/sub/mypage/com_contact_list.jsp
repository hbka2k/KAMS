...
<div id="mypage_contact_applicant_list" class="sub mypage">
            ...
            <div class="mp_cont_wrap cf">
                ...
                <div class="mp_cont">
                    <div class="mp_title_box">
                        <p class="mp_title">연락한 인재</p>
                    </div>

                    <form action="">
                        <div class="board_tb_wrap mp_contact_applicant_list_tb_wrap">
                            <div class="bo_top_inf">
                                <div class="bo_view_type">
                                    <ul class="bo_view_type_ul">
                                        <li class="bo_vsort">
                                            <select name="" id="" class="i-select bo_vsort_sel">
                                                <option value="">최근전송일순</option>
                                                <option value="">예전전송일순</option>
                            ...
                            <table class="board_tb mp_join_list_tb">
                                <caption>연락한 인재 목록</caption>
                                <thead>
                                    <tr>
                                        <th class="mp_join_th_chk">
                                            <div class="i-checks">
                                                <input type="checkbox" id="mp_contact_applicant_list_chkAll" onclick="checkAll(this,'mp_contact_applicant_list_chk')">
                                                <label for="mp_contact_applicant_list_chkAll"><span class="sound_only">전체선택</span></label>
                                            </div>
                                        </th>
                                        <th class="">이름/나이</th>
                                        <th class="">학력</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="i-checks">
                                                <input type="checkbox" id="mp_contact_applicant_list_chk01">
                                                <label for="mp_contact_applicant_list_chk01"><span class="sound_only">연락한 인재 항목</span></label>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td>1년 6개월</td>
                                        <td>예술경영지원센터 구인 모집합니다.</td>
                                        <td>
                                            <span class="mp_apply_state state03">거절</span>
                                            <!--상태값 거절시 사유확인 버튼 노출-->
                                            <button type="button" class="btn03 mp_refusal_btn">사유확인</button>
                                        </td>
                                        <td>2021-01-01</td>
                                    </tr>
                                    <!--} loop-->
                                    <tr>
                                        <td>
                                            <div class="i-checks">
                                                <input type="checkbox" id="mp_contact_applicant_list_chk02">
                                                <label for="mp_contact_applicant_list_chk02"><span class="sound_only">연락한 인재 항목</span></label>
                                            </div>
                                        </td>
                                        <td>
                                            <!--
                                            입사지원한 지원자는 전체이름표시
                                            발송한 구직자는 OO으로 일부만 표시
                                            -->
                                            <a href="/sub/human/search_view.do" class="mp_applicant_inf">
                                                <span class="mp_applicant_name">홍OO</span>
                                                <span class="mp_applicant_age">30</span>
                                            </a>
                                        </td>
                                        <td>경영대학교 컴퓨터공학과 졸업 (대졸4년)</td>
                                        ...
                                        <td>예술경영지원센터 구인 모집합니다.</td>
                                        <td>
                                            <span class="mp_apply_state state01">전송</span>
                                        </td>
                                        <td>2021-01-01</td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <div class="i-checks">
                                                <input type="checkbox" id="mp_contact_applicant_list_chk03">
                                                <label for="mp_contact_applicant_list_chk03"><span class="sound_only">연락한 인재 항목</span></label>
                                            </div>
                                        </td>
                                        <td>
                                            <a href="/sub/human/search_view.do" class="mp_applicant_inf">
                                        ...
                                        <td>예술경영지원센터 구인 모집합니다.</td>
                                        <td>
                                            <span class="mp_apply_state state02">수락</span>
                                        </td>
                                        <td>2021-01-01</td>
                                    </tr>
                                </tbody>
