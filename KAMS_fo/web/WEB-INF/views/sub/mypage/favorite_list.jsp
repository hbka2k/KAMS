...
<div id="mypage_scrap_company_list" class="sub mypage">
            ...
            <div class="mp_cont_wrap cf">
                ...
                <div class="mp_cont">
                    <div class="mp_title_box">
                        <p class="mp_title">관심기업</p>
                    </div>

                    <form action="">
                        <div class="board_tb_wrap mp_scrap_company_list_tb_wrap">
                                    ...
                                    <ul class="bo_view_type_ul">
                                        <li class="bo_vsort">
                                            <select name="" id="" class="i-select bo_vsort_sel">
                                                <option value="">최근등록일일순</option>
                                                <option value="">예전등록일일순</option>
                            ...
                            <table class="board_tb mp_join_list_tb">
                                ...
                                <thead>
                                    <tr>
                                        <th class="mp_join_th_chk">
                                            <div class="i-checks">
                                                <input type="checkbox" id="mp_scrap_company_list_chkAll" onclick="checkAll(this,'mp_scrap_company_list_chk')">
                                                <label for="mp_scrap_company_list_chkAll"><span class="sound_only">입사지원 항목</span></label>
                                            </div>
                                        </th>
                                        <th class="mp_join_th_cname">회사명</th>
                                        <th class="mp_join_th_adate">진행중인 채용</th>
                                        <th class="mp_join_th_rdate">등록일</th>
                                    </tr>
                                </thead>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="i-checks">
                                                <input type="checkbox" id="mp_scrap_company_list_chk01">
                                                <label for="mp_scrap_company_list_chk01"><span class="sound_only">입사지원 항목</span></label>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td class="rp_td rp_td_1023">
                                            <p class="mp_join_list_txt01 rp_td_txt" data-th="진행중인 채용">
                                                <a href="/sub/comJob/com_info_view.do">1</a>건
                                            </p>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="i-checks">
                                                <input type="checkbox" id="mp_scrap_company_list_chk02">
                                                <label for="mp_scrap_company_list_chk02"><span class="sound_only">입사지원 항목</span></label>
                                            </div>
                                        </td>
                                        <td>
                                            <a href="/sub/comJob/com_info_view.do" class="mp_join_list_txt01">예술경영지원센터</a>
