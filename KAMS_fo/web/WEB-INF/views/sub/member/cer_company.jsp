    ...
    <div class="sub_content">
        <div class="wrapper">
            ...
            <div class="signup_cont step03">
                <p class="signup_cont_title">기업회원 가입인증<span>아이핀인증 또는 핸드폰인증 중 하나를 선택하여 회원가입을 진행하시기 바랍니다.</span></p>
                <div class="signup_cont_wrap signup_cont_half i-match">
                    <div class="signup_license_number" style="">
                    ...
                    <div class="signup_cont_st signup_cont_lt" style="height: 244px;">
                        ...
                        <div class="signup_cont_st_btn">
                            <ul class="signup_cont_st_btn_ul">
                                <li><a href="/member/form_company.do" class="btn01">휴대폰&nbsp;인증</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="signup_cont_st signup_cont_rt" style="height: 244px;">
                        ...
                        <div class="signup_cont_st_btn">
                            <ul class="signup_cont_st_btn_ul">
                                <li><a href="/member/form_company.do" class="btn01">아이핀 인증</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
