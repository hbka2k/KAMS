...
<div id="mypage_indiv_talk_list" class="sub mypage">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="mp_bo_td_subj">
                                            <a href="/sub/mypage/one_to_one_view.do" class="mp_join_list_txt01">
                                                <span class="mp_talk_state state01">답변완료</span>
                                                <span class="mp_talk_tit">문의 제목의 보여집니다.</span>
                                            </a>
                                        </td>
                                        <td>
                                            <a href="/sub/recruit/search_view.do" class="mp_join_list_txt01">채용공고 제목이 표시됩니다.</a>
                                        </td>
                                        <td>
