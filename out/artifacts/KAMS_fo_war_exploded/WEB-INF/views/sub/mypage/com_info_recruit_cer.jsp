...
<div id="mypage_comp_mn_check" class="sub mypage">
                        ...
                        <div class="mp_sec mp_compedit_sec">
                            <div class="mp_mbedit_tb_wrap">
                                <table class="signup_fm_tb mp_mbedit_tb">
                                    ...
                                    <tbody>
                                        <tr>
                                            <th><label for="mp_mbedit_chk_pw">현재 담당자명</label></th>
                                            <td>
                                                <input type="text" name="" id="signup_manager_name" class="i-inpt disabled" value="홍길동" disabled="">
                                                <a href="/sub/mypage/com_info_recruit_edit.do" class="signup_fm_btn">아이핀 인증</a>
                                                <a href="/sub/mypage/com_info_recruit_edit.do" class="signup_fm_btn">본인 휴대폰 인증</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="mp_mbedit_submit_box cf">
                                <ul class="mp_mbedit_submit_ul mp_mbedit_submit_ul02">
                                    ...
                                    <li><button type="button" id="mp_mbedit_submit" class="btn01" onclick="location.href='/sub/mypage/com_info_recruit_edit.do'">확인</button></li>
                                </ul>
                            </div>
                        </div>
                    </form>
