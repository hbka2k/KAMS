...
<div id="mypage_today_applicant_list" class="sub mypage">
            ...
            <div class="mp_cont_wrap cf">
                ...
                <div class="mp_cont">
                    <div class="mp_title_box">
                        <p class="mp_title">오늘 본 인재</p>
                    </div>

                    <form action="">
                        <div class="board_tb_wrap mp_today_applicant_list_tb_wrap">
                            ...
                            <table class="board_tb mp_join_list_tb">
                                <caption>오늘 본 인재 목록</caption>
                                <thead>
                                    <tr>
                                        <th class="mp_join_th_chk">
                                            <div class="i-checks">
                                                <input type="checkbox" id="mp_today_applicant_list_chkAll" onclick="checkAll(this,'mp_today_applicant_list_chk')">
                                                <label for="mp_today_applicant_list_chkAll"><span class="sound_only">오늘 본 인재 항목</span></label>
                                            </div>
                                        </th>
                                        <th class="">이름/나이</th>
                                        <th class="">학력</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="i-checks">
                                                <input type="checkbox" id="mp_today_applicant_list_chk01">
                                                <label for="mp_today_applicant_list_chk01"><span class="sound_only">오늘 본 인재 항목</span></label>
                                            </div>
                                        </td>
                                        <td>
