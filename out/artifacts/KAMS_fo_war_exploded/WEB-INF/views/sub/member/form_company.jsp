            ...
            <div class="signup_step_box">
                <ul class="signup_step_ul">
                    ...
                    <li>
                        ...
                        <p class="signup_step_txt">가입인증</p>
                    </li>
                    <li class="active">
                ...
                <div class="signup_cont_wrap">
                    <div class="signup_fm_tb_wrap">
                        <form action="">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="signup_fm_name_fs0">
                                                    ...
                                                    <span class="signup_fm_cau">영문(소문자) 또는 영문(소문자)와 숫자 조합하여 6-24자 이내로 입력하세요.</span>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="signup_fm_sec">
                                <p class="signup_fm_sec_tit">채용담당자 정보</p>
                                <table class="signup_fm_tb">
                                    <caption>회원가입 채용담당자 정보 입력</caption>
                                    <tbody>
                                        <tr>
                                            <th><label for="signup_manager_name">담당자명</label></th>
                                            <td><input type="text" name="" id="signup_manager_name" class="i-inpt disabled" value="홍길동" disabled=""></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <th><label for="signup_mail1">이메일<span class="required">*</span></label></th>
                                            <td>
                            ...
                            <div class="signup_fm_sec">
                                <p class="signup_fm_sec_tit">기업정보</p>
                                <table class="signup_fm_tb">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <th><label for="signup_fm_head_company">회사명<span class="required">*</span></label></th>
                                            <td>
                                                <ul class="signup_fm_cname_chkbox">
                                                    <li class="i-radio">
                                                        <input type="text" name="" id="signup_fm_head_company" class="i-inpt">
                                                        <input type="radio" name="signup_fm_cname_chk" id="signup_fm_cname_chk01" value="" checked="">
                                                        <label for="signup_fm_cname_chk01">본사</label>
                                                    </li>
                                                    <li class="i-radio">
                                                        <input type="radio" name="signup_fm_cname_chk" id="signup_fm_cname_chk02" value="">
                                                        <label for="signup_fm_cname_chk02">지사</label>
                                                        <input type="text" name="" id="signup_fm_branch_company" class="i-inpt">
                                                    </li>
                                                </ul>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th><label for="signup_addr1">주소<span class="required">*</span></label></th>
                                            <td>
                                                <ul>
                                ...
                                <table class="signup_fm_tb">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <p class="signup_fm_raio_txt">아트모아에서 제공하는 취업정보, 행사, 이벤트, 세미나, 박람회 등 새로운 소식을 받으시겠습니까?</p>
                                                <ul class="signup_fm_raio">
                                                    <li class="i-radio">
