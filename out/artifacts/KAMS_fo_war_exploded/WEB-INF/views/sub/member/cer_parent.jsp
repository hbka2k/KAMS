...
<div id="signup_parents" class="sub signup">
    <div class="sub_content">
        <div class="wrapper">
            ...
            <div class="signup_cont step04">
                <p class="signup_cont_title">부모님인증</p>
                <div class="signup_cont_wrap signup_cont_half i-match">
                    <div class="signup_parents_name" style="">
                        <label for="signup_parents_name">부모님 성명</label>
                        <input type="text" name="" id="signup_parents_name" class="i-inpt">
                    </div>
                    <div class="signup_cont_st signup_cont_lt" style="height: 217px;">
                        <p class="signup_cont_st_tit">휴대폰인증</p>
                        <div class="signup_cont_st_cont">
                            부모님 휴대폰 정보로 인증 후 가입하실 수 있습니다.
                        </div>
                        <div class="signup_cont_st_btn">
                            <ul class="signup_cont_st_btn_ul">
                                <li><a href="/member/form.do" class="btn01">휴대폰&nbsp;인증</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="signup_cont_st signup_cont_rt" style="height: 217px;">
                        <p class="signup_cont_st_tit">아이핀(i-PIN) 인증</p>
                        <div class="signup_cont_st_cont">
                            부모님 아이핀 정보로 인증 후 가입하실 수 있습니다.
                        </div>
                        <div class="signup_cont_st_btn">
                            <ul class="signup_cont_st_btn_ul">
                                <li><a href="/member/form.do" class="btn01">아이핀 인증</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
