                        ...
                        <ul class="bo_v_btn_ul">
                            <c:choose>
                                <c:when test="${bbsDetailVo.prev ne null}">
                                    <li class="bo_v_arrow bo_v_prev"><a href="/sub/community/notice_view.do?bbs_detail_idx=${bbsDetailVo.prev.bbs_detail_idx}"><i class="arrow left"></i></a></li>
                                </c:when>
                                <c:otherwise>
                                    <%--<li class="bo_v_arrow bo_v_prev"><a href="#none"><i class="arrow left"></i></a></li>--%>
                                </c:otherwise>
                            </c:choose>
                            <li class="bo_v_list"><a href="/sub/community/notice_list.do">목록</a></li>
                            <c:choose>
                                <c:when test="${bbsDetailVo.next ne null}">
                                    <li class="bo_v_arrow bo_v_next"><a href="/sub/community/notice_view.do?bbs_detail_idx=${bbsDetailVo.next.bbs_detail_idx}"><i class="arrow right"></i></a></li>
                                </c:when>
                                <c:otherwise>
                                    <%--<li class="bo_v_arrow bo_v_prev"><a href="#none"><i class="arrow left"></i></a></li>--%>
                                </c:otherwise>
