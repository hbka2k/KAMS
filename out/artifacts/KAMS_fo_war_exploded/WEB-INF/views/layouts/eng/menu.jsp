...
<div id="header">
    <div class="h_area_top">
        <div class="wrap">
            <h1 class="logo">
                <a href="/ssem/youth/main/main.do"><img src="/ssem/artmore_adm/resources/img/common/logo.png" alt="송파쌤 SSEM"></a>
            </h1>
            ...
            <div id="nav">
                ...
                <ul id="gnb"> <!-- gnb -->
                    ...
                    <li class="depth_1"><a href="/ssem/youth/campus/person_lib_main.do">온라인 캠퍼스</a>  <!-- 온라인 캠퍼스 -->
                        <div class="depth_2_box"><div class="wrap">
                            <div class="depth_title">
                                <div class="depth_title_img"><img src="/ssem/artmore_adm/resources/img/common/depth_title_img_01.jpg" alt="온라인캠퍼스"></div>
                            ...
                            <ul>
                                ...
                                <li class="depth_2"><a href="/ssem/youth/campus/self_main.do">자기주도학습센터</a>
                                    <ul>
                                        <!-- depth_3 -->
                                        <li class="depth_3"><a href="/ssem/youth/campus/self_main.do">자기주도학습센터</a></li>
                                        <li class="depth_3"><a href="/ssem/youth/campus/self_intro.do">소개 및 이용안내</a></li>
                                        <li class="depth_3"><a href="/ssem/youth/campus/self_study_list.do">학습소개</a></li>
                    ...
                    <li class="depth_1"><a href="/ssem/youth/magnet/intro.do">마그넷스쿨</a><!-- 마그넷스쿨 : e-->
                        <div class="depth_2_box"><div class="wrap">
                            <div class="depth_title">
                                <div class="depth_title_img"><img src="/ssem/artmore_adm/resources/img/common/depth_title_img_03.jpg" alt="마그넷스쿨"></div>
                    ...
                    <li class="depth_1"><a href="#">교육지원</a><!-- 교육지원 -->
                        <div class="depth_2_box"><div class="wrap">
                            <div class="depth_title">
                                <div class="depth_title_img"><img src="/ssem/artmore_adm/resources/img/common/depth_title_img_04.jpg" alt="교육지원"></div>
                            ...
                            <ul>
                                ...
                                <li class="depth_2"><a href="/ssem/futurecenter/main/main.do" target="_blank">구립송파 청소년미래센터<i class="icon_link_bk">외부링크</i></a></li>
                    ...
                    <li class="depth_1"><a href="/ssem/youth/ssem/vision.do">송파쌤</a><!-- 송파쌤 -->
                        <div class="depth_2_box"><div class="wrap">
                            <div class="depth_title">
                                <div class="depth_title_img"><img src="/ssem/artmore_adm/resources/img/common/depth_title_img_05.jpg" alt="송파쌤"></div>
    ...
    <div class="icon_btn_wrap wrap t_right">
        <div class="icon_btn_box clserfix">
            ...
            <button type="button" class="float_right icon_btn act_menu"><i class="icon_menu_bk">메뉴</i></button>
        </div>
    </div>
    <div class="search_bar_box off">
            <div class="search_bar mtb_20">
                <form id="frm_search" name="frm_search" action="/ssem/youth/search/search.do" method="post">
                    <input type="text" name="searchVal10" id="searchVal10" class="inp fs_18 fs_sm_26" title="검색입력창">
    ...
    <ul> <!-- gnb -->
        ...
        <li class="depth_1"><a href="#"><span>온라인 캠퍼스</span></a>  <!-- 온라인 캠퍼스 -->
            <ul>
                ...
                <li class="depth_2"><a href="/ssem/youth/campus/self_main.do"><span>자기주도학습센터</span></a>
                    <ul>
                        <!-- depth_3 -->
                        <li class="depth_3"><a href="/ssem/youth/campus/self_main.do"><span>자기주도학습센터</span></a></li>
                        <li class="depth_3"><a href="/ssem/youth/campus/self_intro.do"><span>소개 및 이용안내</span></a></li>
                        <li class="depth_3"><a href="/ssem/youth/campus/self_study_list.do"><span>학습소개</span></a></li>
        ...
        <li class="depth_1"><a href="#"><span>교육지원</span></a><!-- 교육지원 -->
            <ul>
                ...
                <li class="depth_2"><a href="/ssem/futurecenter/main/main.do" target="_blank" class="export_link"><span>구립송파 청소년미래센터</span></a></li>
        ...
        <li class="depth_1"><a href="/ssem/youth/mypage/program_list.do"><span>나의 송파쌤<br><span class="fw_200 fs_24">(마이페이지)</span></span></a><!--나의 송파쌤 -->
            <ul>
                ...
                <li class="depth_2"><a href="/ssem/youth/mypage/online_counsel_list.do"><span>자기주도학습센터</span></a>
                    <ul>
                        <!-- depth_3 -->
