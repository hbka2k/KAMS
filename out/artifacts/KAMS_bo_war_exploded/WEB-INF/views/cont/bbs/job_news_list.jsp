...
<div class="container">
    ...
    <form name="frm" id="frm" method="post" action="/artmore_adm/cont/bbs/job_news_list.do">
    ...
    <article class="contUnit tbl_area">
                            ...
                            <tr class="notice">
                                ...
                                <td class="ta_l">
                                    <div class="line01">
                                        ...
                                        <a href="/artmore_adm/cont/bbs/job_news_view.do?bbs_detail_idx=${item.bbs_detail_idx}" class="line">${item.title}</a>
        ...
        <div class="btnArea">
            ...
            <div class="right">
                <a href="/artmore_adm/cont/bbs/job_news_inscr.do" class="btn red">등록</a>
            </div>
        </div>
    </article>
</div>
