...
<div class="container">
    ...
    <article class="contUnit sch_area">
        ...
        <div class="line">
            <div class="formCont">
                <label for="datepicker_01">등록일자</label>
    ...
    <article class="contUnit tbl_area">
        <div class="btnArea mgt0 mgb10 of_h">
            ...
            <div class="right">
                ...
                <label for="checkboxEmail">이메일 미 수신 제외</label>

                <input type="checkbox" id="checkboxSms">
                <label for="checkboxSms">SMS 미 수신 제외</label>
        ...
        <div class="btnArea">
            ...
            <div class="right">
                <a href="#none" class="btn blue">이메일 전송</a>
                <a href="#none" class="btn sky">SMS 전송</a>
            </div>
        </div>
    </article>
</div>
