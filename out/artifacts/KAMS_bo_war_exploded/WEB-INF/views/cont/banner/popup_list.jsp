    ...
    $(document).ready(function () {
        ...
        $("#btn_select_del").click(function(){
            ...
            if(confirm("선택한 데이터를 삭제 하시겠습니까?.")) {
                ...
                $.ajax({
                    url: '/artmore_adm/ajax/popup_delete.do',
                    type: 'POST',
                    dataType: 'json',
                    data: data,
                    xhrFields: {
...
<div class="container">
    ...
    <form name="frm" id="frm" method="post" action="/artmore_adm/cont/banner/popup_list.do">
    ...
    <article class="contUnit sch_area">
        ...
        <div class="line">
            <div class="formCont">
                <label for="searchKind">노출여부</label>
    ...
    <article class="contUnit tbl_area">
        ...
        <form name="ordfrm" id="ordfrm" method="post" action="/artmore_adm/cont/banner/popup_ord.do" enctype="multipart/form-data">
        <table>
            <colgroup>
                <col style="width:2%">
                <col style="width:6%">
            ...
            <c:forEach items="${itemList}" var="item" varStatus="status">
                <tr>
                    <td><input type="checkbox" name="del_id" id="del_id_${item.popup_idx}" value="${item.popup_idx}"></td>
                    <td>
                        <input type="hidden" name="ordList[${status.index}].idx" id="ordList[${status.index}].idx" value="${item.popup_idx}">
                    ...
                    <td class="ta_l"><a href="/artmore_adm/cont/basic/popup_view.do?popup_idx=${item.popup_idx}" class="line">${item.name}</a></td>
        ...
        <div class="btnArea">
            ...
            <div class="right">
                ...
                <a href="/artmore_adm/cont/banner/popup_inscr.do" class="btn red">등록</a>
            </div>
        </div>
    </article>
</div>
