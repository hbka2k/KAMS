...
<div class="container">
    ...
    <article class="contUnit tbl_area leftType">
        ...
        <form name="delfrm" id="delfrm" action="/artmore_adm/cont/banner/lower_banner_delete.do" method="post" enctype="multipart/form-data">
            <input type="hidden" name="banner_idx" value="${bannerVo.banner_idx}" />
        </form>
        <form name="frm" id="frm" action="/artmore_adm/cont/banner/lower_banner_view.do" method="post" enctype="multipart/form-data">
