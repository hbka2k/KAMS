...
$.extend(Grid.prototype, {
	...
	bgCellHtml: function(row, col, date) {
		...
		return '<td class="' + classes.join(' ') + '" data-date="' + date.format() + '" id="no_' + date.format() + '"></td>';
	},
...
$.extend(DayGrid.prototype, {
	...
	fgSegHtml: function(seg, disableResizing) {
		...
		if (!event.allDay && seg.isStart) {
			timeHtml = '<span class="fc-time hiddenSchedule">' + htmlEscape(view.getEventTimeText(event)) + '</span>';
		}
...
$.extend(BasicView.prototype, {
	...
	numberCellHtml: function(row, col, date) {
		...
		return '' +
			'<td class="' + classes.join(' ') + '" data-date="' + date.format() + '" id="yes_' + date.format() + '">' +
				date.date() +
			'</td>';
	},
