...
<div class="container">
    ...
    <form name="frm" id="frm" method="post" action="/artmore_adm/cont/banner/link_banner_list.do">
    ...
    <article class="contUnit tbl_area">
        ...
        <form name="ordfrm" id="ordfrm" method="post" action="/artmore_adm/cont/banner/link_banner_ord.do" enctype="multipart/form-data">
        <table>
            <colgroup>
                <col style="width:2%">
                <col style="width:6%">
            ...
            <c:forEach items="${itemList}" var="item" varStatus="status">
                <tr>
                    ...
                    <td class="ta_l"><a href="/artmore_adm/cont/banner/link_banner_view.do?banner_idx=${item.banner_idx}" class="line">${item.name}</a></td>
        ...
        <div class="btnArea">
            ...
            <div class="right">
                ...
                <a href="/artmore_adm/cont/banner/link_banner_inscr.do" class="btn red">등록</a>
            </div>
        </div>
    </article>
</div>
