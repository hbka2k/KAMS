...
<div class="container">
    ...
    <article class="contUnit tbl_area leftType">
        ...
        <form name="frm" id="frm" action="/artmore_adm/cont/bbs/notice_upscr.do" method="post" enctype="multipart/form-data">
        ...
        <div class="btnArea">
            <div class="left">
                <a href="/artmore_adm/cont/bbs/notice_list.do" class="btn">목록</a>
            </div>
            <div class="right">
