...
<div class="container">
    ...
    <form name="delfrm" id="delfrm" action="/artmore_adm/cont/bbs/file_info_delete.do" method="post" enctype="multipart/form-data">
    ...
    <article class="contUnit tbl_area leftType">
        ...
        <div class="btnArea">
            <div class="left">
                <a href="/artmore_adm/cont/bbs/file_info_list.do" class="btn">목록</a>
            </div>
            <div class="right">
                <a href="#none" class="btn grey" id="btn_delete">삭제</a>
                <a href="/artmore_adm/cont/bbs/file_info_upscr.do?bbs_detail_idx=${bbsDetailVo.bbs_detail_idx}" class="btn red">수정</a>
            </div>
        </div>
    </article>
</div>
