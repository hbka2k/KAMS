...
<div class="container">
    ...
    <form name="delfrm" id="delfrm" action="/artmore_adm/cont/bbs/notice_delete.do" method="post" enctype="multipart/form-data">
    ...
    <article class="contUnit tbl_area leftType">
        ...
        <div class="btnArea">
            ...
            <div class="right">
                ...
                <a href="/artmore_adm/cont/bbs/notice_upscr.do?bbs_detail_idx=${bbsDetailVo.bbs_detail_idx}" class="btn red">수정</a>
            </div>
        </div>
    </article>
</div>
