...
public class AppServiceImpl implements AppService {
    ...
    @Override
    public List<CodeVo> selectCodeList(String part_cd) throws Exception {
        return appRepository.selectCodeList(part_cd);
    }

    @Override
    public String selectCodeNm(int code_idx) throws Exception {
        return appRepository.selectCodeNm(code_idx);
    }
