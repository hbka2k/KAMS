...
/**
 * Program Name : kr.or.jobkams.common
 * Author : shlee
 * Date : 2020-09-14
 * Description :
 * History :
...
public class PageLinkAdminTag extends TagSupport {
    ...
    public int doEndTag() throws JspTagException {
        ...
        try {
            ...
            if (page == 1) {
                sb.append("<li class=\"first\"><a href=\"#\" alt=\"처음으로\"><span class=\"material-icons\">keyboard_arrow_left</span><span class=\"material-icons\">keyboard_arrow_left</span></a></li>");
            } else {
            ...
            if (page != 1) {
                ...
                sb.append("<li class=\"prev\"><a href=\"#\" alt=\"이전\"><span class=\"material-icons\">keyboard_arrow_left</span></a></li>");
            }
            //--------------페이지 번호--------------
            for (int i = pageBlockNo; i < pageBlockNo + pageBlockSize; i++) {
                ...
                if (page == i) {
                    ...
                    sb.append("<li><a href=\"?page=" + (i) + paramString + "\">" + i + "</a></li>");
                }
            }
            //---------------- 다음 xx개-----------
            //if (pageBlockGroupNo != ((totalPage - 1) / pageBlockSize) * 1 + 1) {
            if (totalPage != page) {
                sb.append("<li class=\"next\"><a href=\"?page=" + (page+1) + paramString + "\" title=\"다음\" alt=\"다음\"><span class=\"material-icons\">keyboard_arrow_right</span></a></li>");
            } else {
                sb.append("<li class=\"next\"><a href=\"#\" alt=\"다음\"><span class=\"material-icons\">keyboard_arrow_right</span></a></li>");
            }
            if (page == totalPage) {
                sb.append("<li class=\"last\"><a href=\"#\" alt=\"끝으로\"><span class=\"material-icons\">keyboard_arrow_right</span><span class=\"material-icons\">keyboard_arrow_right</span></a></li>");
            } else {
                sb.append("<li class=\"last\"><a href=\"?page=" + totalPage + paramString + "\"  title=\"끝으로\" alt=\"끝으로\"><span class=\"material-icons\">keyboard_arrow_right</span><span class=\"material-icons\">keyboard_arrow_right</span></a></li>");
            }
            sb.append("</ul>");
            sb.append("</div>");
